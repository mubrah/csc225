...
void addsame(linkedlist *thishead, int wordn){
    ...
    newnode->wordn = wordn;
    newnode->sameword = NULL;
    while(thishead->sameword != NULL){
        thishead = thishead->sameword;
    }
    thishead->sameword = newnode;
}
...
void removelist(linkedlist *thishead) {
    ...
    linkedlist *samewordtemp = NULL;
    linkedlist *samewordtrain = NULL;
    ...
    while(thishead != NULL){
        ...
        printf("\n");
        if(thishead->sameword != NULL){
            printf("Same line as above, word(s): ");
            samewordtrain = thishead->sameword;
            while(samewordtrain != NULL){
                samewordtemp = samewordtrain;
                printf("%d", samewordtemp->wordn);
                samewordtrain = samewordtrain->sameword;
                free(samewordtemp);
                if(samewordtrain != NULL){
                    printf(", ");
                }else{
                    printf("\n");
                }
